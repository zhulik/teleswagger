...
module Teleswagger
  ...
  class ChatMember
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'can_be_edited')
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ["creator", "administrator", "member", "restricted", "left", "kicked"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["creator", "administrator", "member", "restricted", "left", "kicked"])
    ...
    def hash
      [user, status, until_date, can_be_edited, can_change_info, can_post_messages, can_edit_messages, can_delete_messages, can_invite_users, can_restrict_members, can_pin_messages, can_promote_members, can_send_messages, can_send_media_messages, can_send_other_messages, can_add_web_page_previews].hash
    end
