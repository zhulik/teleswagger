...
module Teleswagger
  ...
  class InlineKeyboardButton
    ...
    def hash
      [text, url, callback_data, switch_inline_query, switch_inline_query_current_chat, callback_game, pay].hash
    end
