...
module Teleswagger
  ...
  class SendVideoNoteLinkBody
    ...
    def list_invalid_properties
      ...
      if @video_note.nil?
        invalid_properties.push("invalid value for 'video_note', video_note cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @video_note.nil?
      return true
    end
    ...
    def hash
      [chat_id, video_note, duration, length, disable_notification, reply_to_message_id, reply_markup].hash
    end
