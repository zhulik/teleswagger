...
module Teleswagger
  ...
  class CreateNewStickerSetLinkBody
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'is_masks')
        self.is_masks = attributes[:'is_masks']
      end
    ...
    def hash
      [user_id, name, title, png_sticker, emojis, is_masks, mask_position].hash
    end
