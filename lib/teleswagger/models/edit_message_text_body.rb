...
module Teleswagger
  ...
  class EditMessageTextBody
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'disable_web_page_preview')
    ...
    def hash
      [chat_id, message_id, inline_message_id, text, parse_mode, disable_web_page_preview, reply_markup].hash
    end
