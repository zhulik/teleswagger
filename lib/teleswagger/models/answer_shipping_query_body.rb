...
module Teleswagger
  ...
  class AnswerShippingQueryBody
    attr_accessor :shipping_query_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'shipping_query_id')
        self.shipping_query_id = attributes[:'shipping_query_id']
      end
    ...
    def valid?
      return false if @shipping_query_id.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          shipping_query_id == o.shipping_query_id &&
          ok == o.ok &&
    ...
    def hash
      [shipping_query_id, ok, shipping_options, error_message].hash
    end
