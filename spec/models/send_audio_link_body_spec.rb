...
# Unit tests for Teleswagger::SendAudioLinkBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SendAudioLinkBody' do
  before do
    # run before each test
    @instance = Teleswagger::SendAudioLinkBody.new
  end
  ...
  describe 'test an instance of SendAudioLinkBody' do
    it 'should create an instance of SendAudioLinkBody' do
      expect(@instance).to be_instance_of(Teleswagger::SendAudioLinkBody)
    end
  end
