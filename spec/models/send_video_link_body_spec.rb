...
# Unit tests for Teleswagger::SendVideoLinkBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SendVideoLinkBody' do
  before do
    # run before each test
    @instance = Teleswagger::SendVideoLinkBody.new
  end
  ...
  describe 'test an instance of SendVideoLinkBody' do
    it 'should create an instance of SendVideoLinkBody' do
      expect(@instance).to be_instance_of(Teleswagger::SendVideoLinkBody)
    end
  end
